...
.EXAMPLE
When invoked from the root directory of your project, will compose up the project into the docker-machine instance named 'default'
PS> .\Docker\DockerTask.ps1 -Run -Environment Debug -Machine default 
...
$env:WORKSONMYMACHINE_PORT = $ContainerPort
